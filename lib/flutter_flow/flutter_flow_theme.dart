...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF05686C);
  late Color secondary = const Color(0xFF65A8AB);
  late Color tertiary = const Color(0xFFD2AB80);
  late Color alternate = const Color(0xFFF9EBC7);
  late Color primaryText = const Color(0xFF333333);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFEBE0C4);
  late Color secondaryBackground = const Color(0xFFF9EBC7);
  late Color accent1 = const Color(0xFFE5E0D8);
  late Color accent2 = const Color(0xFFD2AB80);
  late Color accent3 = const Color(0xFF05686C);
  late Color accent4 = const Color(0xFF65A8AB);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF65A8AB);
  late Color secondary = const Color(0xFF05686C);
  late Color tertiary = const Color(0xFFD2AB80);
  late Color alternate = const Color(0xFF2E3B3C);
  ...
  late Color accent1 = const Color(0xFF4F5F60);
  late Color accent2 = const Color(0xFF7A8B8C);
  late Color accent3 = const Color(0xFF3C4C4D);
  late Color accent4 = const Color(0xFFA3B1B2);
