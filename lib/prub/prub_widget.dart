...
import 'prub_model.dart';
export 'prub_model.dart';

class PrubWidget extends StatefulWidget {
  const PrubWidget({super.key});

  @override
  State<PrubWidget> createState() => _PrubWidgetState();
}

class _PrubWidgetState extends State<PrubWidget> {
  late PrubModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrubModel());
